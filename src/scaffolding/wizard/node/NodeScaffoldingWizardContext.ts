...
export interface NodeScaffoldingWizardContext extends ServiceScaffoldingWizardContext {
    nodeCmdParts?: string[];
    nodeDebugCmdParts?: string[];
}

export function getNodeSubWizardOptions(wizardContext: ServiceScaffoldingWizardContext): IWizardOptions<NodeScaffoldingWizardContext> {
